...
function(b){f.targetEl=b.currentTarget;b=a(f.targetEl);a("#bigBgshowDiv").css("backgroundColor","#000000");a("#bigHexColorText").val("#000000");b=p(b);a("#bigpicker").css({left:b.left+"px",top:b.top+"px",zIndex:"999"}).fadeIn(300);b=a("#bigSections").position();a("#bigLayout").css({left:b.left,top:b.top}).show()});a(document).bind("mousedown",function(b){a(b.target).parents().andSelf().is("#bigpicker")||a("#bigpicker").hide()});if(d!=void 0)try{d=d.toUpperCase()}catch(g){d="P"}if(d=="L")a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").removeClass("bigpicker-bgimage"),
