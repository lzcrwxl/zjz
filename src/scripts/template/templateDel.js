        ...
        $(this).each(function () {
            ...
            me.addDropzone = function (selector, func) {
                $(selector).on('mouseenter', function () {
                    ...
                    $(this).parents(".module").append('<b class="module-del">×</b><b class="module-up">↑</b> <b class="module-down">↓</b>');
                    if (mouse.target != false) {
            ...
            daddy.on('mousedown touchstart', jq,function (e) {
                $(this).parents(".module").find(".module-del").remove();
                $(this).parents(".module").find(".module-up").remove();
                $(this).parents(".module").find(".module-down").remove();
            ...
            daddy.on('mouseenter',jQclass, function () {
                dad_update($(this))
            })
        });
        return this
